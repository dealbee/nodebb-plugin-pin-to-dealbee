...
Controllers.renderPinChoosePage = function (req, res) {
	res.render('pinPreview.tpl', { categories: req.modOfCateories, title: 'Pin choose' });
};
Controllers.renderPreviewPage = function(req, res){
	// console.log("Rendering...")
	// console.log(req.positionData.positionTypes);
	res.render('pagePreview.tpl', {  positionTypes: req.positionData.positionTypes, title: 'Pin preview' });
}
